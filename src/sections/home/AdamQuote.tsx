...
const AdamQuote = () => {
  return (
    <section className="px-4 md:px-[6%] mb-12 md:mb-16 mx-auto">
      <div className="rounded-lg  bg-linear-to-r from-[#1f1f20] to-[#1f1f20] via-black relative flex-col   flex items-center justify-center py-16 md:py-20 mt-16 px-4">
        ...
        <h3 className="text-white  md:max-w-5xl font-pt-serif tracking-tight  px-4 leading-[1.3] mt-6 text-2xl md:text-3xl lg:text-4xl  text-center ">
