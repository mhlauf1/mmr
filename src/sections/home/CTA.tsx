...
const CTA = () => {
  return (
    <section className="bg-[#202023] relative h-[60vh] md:h-[75vh]">
      <div className="px-4 sm:px-8 h-full justify-center py-8 items-center flex flex-col">
        <div className="flex flex-col md:mt-auto  items-center">
          <h2 className="text-5xl max-w-lg md:max-w-xl text-white md:text-7xl font-medium tracking-tight text-center">
