  ...
  return (
    <section className="bg-[#202023] py-12 md:py-24 items-center px-[5%] flex flex-col md:flex-row gap-16">
      <div className="flex flex-col items-start flex-1">
        <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl text-center md:tex-start md:max-w-[18ch] tracking-tight text-neutral-100 font-medium leading-tight">
        ...
        <p className="text-neutral-200 mt-8 text-md text-center md:tex-start md:text-lg">
        ...
        <p className="text-neutral-200 mt-8 text-center md:tex-start text-md md:text-l">
