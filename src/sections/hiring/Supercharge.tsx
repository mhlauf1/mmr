  ...
  return (
    <section className="bg-[#202023] py-12 md:py-24 items-center px-4 md:px-[4%] lg:px-[5%] flex flex-col md:flex-row gap-16">
      <div className="flex flex-col items-center md:items-start flex-1">
        <h2 className="mt-4 text-3xl sm:text-4xl md:text-5xl text-start font-pt-serif  tracking-tight text-neutral-100 font-medium">
          How We Supercharge Your Hiring Process
        </h2>
        <p className="text-neutral-100 mt-4 md:mt-8 text-md text-start  leading-relaxed md:text-lg">
